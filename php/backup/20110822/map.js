...
function map_init(){
	...
	for(h = 0; h < n; h++)
	{
		...
		var bn = "box" + "" + h;
		var bnt = "boxtx" + "" + h;
		$("#map_area").append('<div id=' + bn + ' style="top: '+ cy +'px; left: ' + cx + 'px; width: 200px; height: 150px; background-color: white; position: absolute; border: 1px solid #000; " ><img src=' + img_ar[h] + ' align="left"></img><span style="font-size:x-small;" >' + dt_ar[h] + '</span><br/><i>' + ujb_ar[h] + '</i><br/><a href="">' + unm_ar[h] + '<a><br clear="left"><div id=' + bnt + ' ></div><a href="eval.php?evl=1&cid=' + cid_ar[h] + '">創</a><a href="eval.php?evl=2&cid=' + cid_ar[h] + '">知</a><a href="eval.php?evl=3&cid=' + cid_ar[h] + '">感</a></div>');
...
//	alert(bon);
	$("#box").replaceWith('<div id=' + bon + ' style="top: '+ w_y +'px; left: ' + w_x +'px; width: 200px; height: 150px; background-color: white; position: absolute; border: 1px solid #000; " ><img src=' + uimg + ' align="left" ></img><span style="font-size:x-small;" >' + ctm + '</span><br/><i>' + ujob  + '</i><br/><a href="">' + unam  + '</a><br clear="left"><div id=' + bont + '></div><a href="">創</a><a href="">知</a><a href="">感<a></div>');
	var txarr = txt.split("\n");
	var txtn = txarr[0];
